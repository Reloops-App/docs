...
To turn a revised upload into a new version, wait for the upload to finish, then drag the new asset card onto the original card. The stack keeps comments, version numbers, and compare mode under one asset. See [Version History and Compare Mode](/review/version-history-and-compare) for the full workflow.
