...
3. Select a folder from your device - every subfolder and file inside is uploaded in the same structure.<br />
   <Frame caption="The Upload dropdown menu highlighting the option to select and upload an entire folder hierarchy.">
...
<video src="/videos/move-folder-1.mp4" controls />
...
<video src="/videos/copy-folder.mp4" controls />
