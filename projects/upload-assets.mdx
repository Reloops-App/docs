...
Reloops supports common creative file types. Images, videos, PDFs, audio, and website captures get dedicated review surfaces. Text and data files can still be stored, organized, downloaded, tagged, and shared as project assets.
...
<CardGroup cols={2}>
  ...
  <Card title="Audio" icon="music">
    MP3, M4A, WAV, FLAC, AAC, and OGG files support playback, timecoded comments, and embedded cover artwork when available.
  </Card>

  <Card title="Documents and other files" icon="file">
    PDFs get a dedicated review surface. Text, CSV, and JSON files can be uploaded as project assets.
  </Card>
</CardGroup>
