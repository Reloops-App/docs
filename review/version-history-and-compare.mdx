...
<Frame caption="On the asset review page, click the version pill beside the asset name, such as v2, to open version actions.">
...
<Frame caption="Versioned asset cards show a version badge, such as v1 or v2, in the card header.">
  ![Assets view filtered to In review status with a version badge on the asset card](/images/quick-view-status-in-review-grid.png)
</Frame>
